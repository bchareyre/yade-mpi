...
class FpsTracker : public QGLSubWindow
{	
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private : void drawString(QString str,int x,int y,float * c);
	
	// construction
	public : FpsTracker (QGLViewer * glViewer, int minX=10, int minY=10, int sizeX=100, int sizeY=100);
