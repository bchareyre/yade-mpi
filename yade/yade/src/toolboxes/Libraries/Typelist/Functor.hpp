...
////////////////////////////////////////////////////////////////////////////////
//
// note by Janek Kozicki, cosurgi@berlios.de
//
// I've removed ThreadingModel because it is used only to optimize speed of
// allocation/deallocation of Functors in memory. We don't do this that ofen 
// (create/destroy functors) so it can be slow. And I've removed this, because
// I'm afraid of compilation problems with Loki::Singleton that is needed by
// SmallObject. It can be added later, I don't want to waste time on this now.
//
// And that would be another Singleton.hpp in yade, becase we already use our
// own singleton, which is different from Loki::Singleton. I tried to use
// Loki::Singleton but it was not compiling.
//
////////////////////////////////////////////////////////////////////////////////
