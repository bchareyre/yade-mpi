...
class Sphere2Sphere4SDECContactModel : public CollisionFunctor
{
	// construction
	public : Sphere2Sphere4SDECContactModel ();
	public : virtual ~Sphere2Sphere4SDECContactModel ();
...
REGISTER_FACTORABLE(Sphere2Sphere4SDECContactModel);
