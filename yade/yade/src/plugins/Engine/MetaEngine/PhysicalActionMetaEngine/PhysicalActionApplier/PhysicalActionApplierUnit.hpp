...
#ifndef __PHYSICALACTIONAPPLYINGUNIT_HPP__
#define __PHYSICALACTIONAPPLYINGUNIT_HPP__
...
class PhysicalActionApplierUnit : public FunctorWrapper
		<
		 void ,
...
#endif // __PHYSICALACTIONAPPLYINGUNIT_HPP__
