#include "BroadInteractionEngineUnit.hpp"
...
BroadInteractionEngineUnit::BroadInteractionEngineUnit () : BroadInteractor()
{
...
BroadInteractionEngineUnit::~BroadInteractionEngineUnit ()
{
...
void BroadInteractionEngineUnit::postProcessAttributes(bool)
{
...
void BroadInteractionEngineUnit::registerAttributes()
{
}
...
void BroadInteractionEngineUnit::broadInteractionTest(Body * /*body*/)
{
	//nbPotentialInteractions=0;
	...
	/*for(unsigned int i=0;i<bodies.size()-1 ; i++)
	{
		...
		for(unsigned int j=i+1;j<bodies.size() ; j++)
		{
			...
			{
				volatileInteractions.push_back(shared_ptr<Interaction>(new Interaction(i,j)));
