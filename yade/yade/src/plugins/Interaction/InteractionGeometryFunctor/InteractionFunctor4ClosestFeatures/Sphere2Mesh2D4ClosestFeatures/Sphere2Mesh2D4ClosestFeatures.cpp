...
bool Sphere2Mesh2D4ClosestFeatures::go(		const shared_ptr<InteractionDescription>& cm1,
...
bool Sphere2Mesh2D4ClosestFeatures::goReverse(	const shared_ptr<InteractionDescription>& cm1,
						const shared_ptr<InteractionDescription>& cm2,
						const Se3r& se31,
						const Se3r& se32,
						shared_ptr<Interaction>& c)
