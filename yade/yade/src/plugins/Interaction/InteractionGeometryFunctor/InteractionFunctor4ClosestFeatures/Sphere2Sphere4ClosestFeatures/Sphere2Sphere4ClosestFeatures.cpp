...
bool Sphere2Sphere4ClosestFeatures::go(		const shared_ptr<BodyInteractionGeometry>& cm1,
...
bool Sphere2Sphere4ClosestFeatures::goReverse(	const shared_ptr<BodyInteractionGeometry>& cm1,
						const shared_ptr<BodyInteractionGeometry>& cm2,
						const Se3r& se31,
						const Se3r& se32,
						shared_ptr<Interaction>& c)
