...
ActionParameterMomentum::ActionParameterMomentum() : PhysicalAction()
{
	createIndex();
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
/* FIXME - not used
void ActionParameterMomentum::add(const shared_ptr<PhysicalAction>& a)
{
...
void ActionParameterMomentum::sub(const shared_ptr<PhysicalAction>& a)
{
	ActionParameterMomentum * m = static_cast<ActionParameterMomentum*>(a.get());
	momentum -= m->momentum;
}
...
shared_ptr<PhysicalAction> ActionParameterMomentum::clone()
{
