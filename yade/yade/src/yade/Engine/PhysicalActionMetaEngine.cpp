...
void PhysicalActionMetaEngine::postProcessAttributes(bool deserializing)
{
...
void PhysicalActionMetaEngine::registerAttributes()
{
...
void PhysicalActionMetaEngine::action(Body* body)
{
