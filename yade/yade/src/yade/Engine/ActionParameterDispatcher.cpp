...
void PhysicalActionApplierMetaEngine::postProcessAttributes(bool deserializing)
{
...
void PhysicalActionApplierMetaEngine::registerAttributes()
{
...
void PhysicalActionApplierMetaEngine::action(Body* body)
{
