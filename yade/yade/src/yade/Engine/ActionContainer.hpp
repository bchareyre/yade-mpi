...
//
// you should never have to create new Action ! (that takes too much time), except for calling prepare, which is done only once
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public    : virtual void prepare(std::vector<shared_ptr<Action> >& )			{throw;};
