...
Body::Body () : Serializable() , id(0) , interactions(new InteractionVecSet)
{
}

Body::Body (unsigned int newId) : Serializable() , id(newId) , interactions(new InteractionVecSet)
{
}
...
void Body::afterDeserialization()
{
