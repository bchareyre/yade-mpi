...
class Serializable
{
	...
	public    : virtual void serialize(any& ) { throw SerializableError(ExceptionMessages::SetFunctionNotDeclared);};
	public    : virtual void deserialize(any& ) { throw SerializableError(ExceptionMessages::GetFunctionNotDeclared);};
