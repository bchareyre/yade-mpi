...
#include <yade/yade-common/SDECLinkGeometry.hpp> // FIXME - I can't dispatch by SDECLinkGeometry <-> MacroMicroContactGeometry !!?
#include <yade/yade-common/SDECLinkPhysics.hpp> // FIXME
