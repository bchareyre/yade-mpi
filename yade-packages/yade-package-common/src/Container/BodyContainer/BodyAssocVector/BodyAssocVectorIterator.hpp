...
#ifndef __BODYASSOCVECTORITERATOR__
#define __BODYASSOCVECTORITERATOR__
...
{
	public : Loki::AssocVector<unsigned int , shared_ptr<Body> >::iterator bii;

	public : BodyAssocVectorIterator();
	public : ~BodyAssocVectorIterator();
