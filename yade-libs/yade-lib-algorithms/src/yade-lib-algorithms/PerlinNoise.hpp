...
{
	public :
		static double coherentNoise(double p, int octaves, double persistence, double noiseOrigin=0.0);
		...
		static double coherentNoise(const Vector2d& p, int octaves, double persistence, const Vector2d& noiseOrigin=Vector2d::ZERO);
		...
		static double coherentNoise(const Vector3d& p, int octaves, double persistence, const Vector3d& noiseOrigin=Vector3d::ZERO);
		...
		static double coherentNoise(const Vector4d& p , int octaves, double persistence, const Vector4d& noiseOrigin=Vector4d::ZERO);
