...
template< > inline void glMaterialv< Vector3r >	( GLenum face, GLenum pname, const Vector3r params )	{	const GLfloat _p[3]={params[0],params[1],params[2]}; glMaterialfv(face,pname,_p);	};
