...
// void PeriodicFlow::MeasurePressureProfile(double Wall_up_y, double Wall_down_y)
// {  
...
// 	if (DEBUG_OUT) cout <<"z_max"<< z_max;
// 	if (DEBUG_OUT) cout <<"z_min"<< z_min;
// 	if (DEBUG_OUT) cout <<"x_max"<< x_max;
// 	if (DEBUG_OUT) cout <<"x_min"<< x_min;
// 	if (DEBUG_OUT) cout <<"Wall_up_y"<< Wall_up_y;
// 	if (DEBUG_OUT) cout <<"Wall_down_y"<< Wall_down_y;
// 	
...
// 		if (DEBUG_OUT) cout <<"Z"<< Z<<endl;
// 		permeameter = Tri.locate(Point(X, Y, Z));
// 		pressure+=permeameter->info().p();
// 		if (DEBUG_OUT) cout <<"pressure "<< pressure<<endl;
// 		cell++;
//         }
//         if (DEBUG_OUT) cout <<"cell "<<cell <<" pressure "<< pressure<<endl;
//         Y += Ry;
//         capture  << pressure/cell << endl;
// 	if (DEBUG_OUT) cout <<"Y "<<Y<<" pressure/cell "<< pressure/cell<<endl;
// 	}
//         
// }
