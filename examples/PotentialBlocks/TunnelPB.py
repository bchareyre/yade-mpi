## CWBoon 2016
## The function stopfunction is used to control when to excavate and install supports
## To print vtk files, set:
## 	printBolt(1)
## 	vtkRecorderTunnel.iterPeriod=1
## 	lining.vtkIteratorInterval=1
#	Use ParaView 3.12 Use 2D Glyph and Edge Arrows to display lining forces
...
p.neverErase = False 
p.filenameOpening = '/home/boon/yadeRev/trunk/examples/Tunnel/joints/circleOriginal.csv'   # update this to appropriate folder
p.filenameProbabilistic ='/home/boon/yadeRev/trunk/examples/Tunnel/joints/old/reducedG2/statistics/G3joints155_75_25A.csv' # update this to appropriate folder
	...
	for b in O.bodies:
		...
		if posX**2 + posZ**2 - (1.2*radius)**2 < 0.0: # and b.dynamic == True:
			if b.isClumpMember == True and b.shape.erase==True:
				...
				O.bodies.erase(b.id)
		'''
		if openingCircle(posX,posY,posZ) < 1e-4 and b.dynamic == True: #posX**2 + posZ**2 - (1.0*radius)**2 < 0.0 openingCircle openingDense openingBenchmark
...
def stopfunction():
	...
	global stage4
	global bodyY
	if O.iter > 450 and bodyY[0].dynamic ==True: #13000
		O.pause()
		stopLateralBodies()
		O.run()
	elif O.iter > 500 and bodyY[0].dynamic==False and supportInstalled == False: #15000
		O.pause()
		...
		physDispatcher.viscousDamping = 0.5
		for i in O.interactions:
		...
		printBolt(2500)
		O.engines = O.engines+ [PyRunner(command='printSupportForces()',iterPeriod=100,label='supportRecorder')]
		O.run()
...
O.engines = O.engines + [PotentialBlockVTKRecorderTunnel(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',iterPeriod=5000,sampleX=40,sampleY=1,sampleZ=40,maxDimension=0.05,twoDimension=True,REC_INTERACTION=True,REC_VELOCITY=True, label='vtkRecorderTunnel')]
#O.engines = O.engines + [PotentialBlockVTKRecorder(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/TunnelClump',iterPeriod=1,sampleX=40,sampleY=1,sampleZ=40,maxDimension=0.05,twoDimension=True,label='vtkRecorder' )]
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='Minus22_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.9239,0,0.3827), normalStiffness=Kaxial, shearStiffness=Kshear, preTension=tension, axialMax=Pult,shearMax=Sult,openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltMinus225' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='Minus11_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.9808,0,0.1951), normalStiffness=Kaxial, shearStiffness=Kshear, preTension=tension,axialMax=Pult,shearMax=Sult,openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut, label='boltMinus11_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='0',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-1,0,-0.0), normalStiffness=Kaxial, shearStiffness=Kshear,preTension =tension, axialMax=Pult,shearMax=Sult, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut, label='bolt0' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='11_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.9808,0,-0.1951), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt11_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='22_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.9239,0.0,-0.3827), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt225' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='33_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.8315,0,-0.5556), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt33_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='45',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.7071,0.0,-0.7071), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension ,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt45')] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='56_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.5556,0,-0.8315), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt56_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='67_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.3827,0.0,-0.9239), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension ,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt675')] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='78_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.1951,0,-0.9808),normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt78_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='90',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0,0,-1.0), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt90' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='101_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.1951,0,-0.9808), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt101_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='112_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.3827,0,-0.9239), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt113' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='123_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.5556,0,-0.8315), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt123_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='135',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.7071,0,-0.7071), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt135' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='146_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.8315,0,-0.5556), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt146_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='157_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9239,0,-0.3827), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt158' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='168_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9808,0,-0.1951), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt168_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='180',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(1,0,0.0), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt180' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='191_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9808,0,0.1951), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt191_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='202_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9239,0.0,0.3827), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt2025' )] + O.engines[3:]

O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='L1',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.08716,0,-0.9962), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter ,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltL1' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='L2',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.2924,0,-0.9563), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltL2' )] + O.engines[3:]

O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='R1',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.08716,0,-0.9962), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut ,label='boltR1' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='R2',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.2924,0,-0.9563), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltR2' )] + O.engines[3:]


O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='15',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.96593,0,-0.25882), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt15' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='30',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.866,0,-0.5), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt30' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='60',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.5,0,-0.866), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt60' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.2588,0,-0.96593), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='105',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.2588,0,-0.96593), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt105' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='120',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.5,0,-0.866), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt120' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='150',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.866,0,-0.5), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt150' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='165',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.96593,0,-0.25882), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt165' )] + O.engines[3:]

O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='10',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='20',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='25',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='35',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='40',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='50',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='55',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='65',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='70',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='80',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='85',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='95',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='100',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='110',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='115',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='125',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='130',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='140',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='145',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='155',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='160',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='170',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='175',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='m5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='m10',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='m15',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.96593,0,0.25882), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltm15' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='mEast5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='mEast10',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='m7_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='m2_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='2_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='7_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='12_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='17_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='27_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='32_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='37_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='42_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='47_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='52_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='57_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='62_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='72_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='77_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='82_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='87_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='92_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='97_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='102_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='107_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='117_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='122_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='127_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='132_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='137_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='142_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='147_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='152_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='162_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='167_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='172_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='177_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='182_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='187_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='/home/boon/yadeRev/trunk/examples/Tunnel/vtk/Tunnel',name='192_5',iterPeriod=1,
...
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltMinus225.txt','w')
f.write('boltMinus225f\tboltMinus225axial\tboltMinus225shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt0.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt225.txt','w')
f.write('bolt225f\tbolt225axial\tbolt225shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt45.txt','w')
f.write('bolt45f\tbolt45axial\tbolt45shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt675.txt','w')
f.write('bolt675f\tbolt675axial\tbolt675shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt90.txt','w')
f.write('bolt90f\tbolt90axial\tbolt90shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt113.txt','w')
f.write('bolt113f\tbolt113axial\tbolt113shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt135.txt','w')
f.write('bolt135f\tbolt135axial\tbolt135shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt158.txt','w')
f.write('bolt158f\tbolt158axial\tbolt158shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt180.txt','w')
f.write('bolt180f\tbolt180axial\tbolt180shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt2025.txt','w')
f.write('bolt2025f\tbolt2025axial\tbolt2025shear\truptured\tnodePosFrCentre\n')
f.close()

f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltMinus11_25.txt','w')
f.write('boltMinus11_25f\tboltMinus11_25axial\tboltMinus11_25shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt11_25.txt','w')
f.write('bolt11_25f\tbolt11_25axial\tbolt11_25shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt33_75.txt','w')
f.write('bolt33_75f\tbolt33_75axial\tbolt33_75shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt56_25.txt','w')
f.write('bolt56_25f\tbolt56_25axial\tbolt56_25shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt78_75.txt','w')
f.write('bolt78_75f\tbolt78_75axial\tbolt78_75shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt101_25.txt','w')
f.write('bolt101_25f\tbolt101_25axial\tbolt101_25shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt123_75.txt','w')
f.write('bolt123_75f\tbolt123_75axial\tbolt123_75shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt146_25.txt','w')
f.write('bolt146_25f\tbolt146_25axial\tbolt146_25shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt168_75.txt','w')
f.write('bolt168_75f\tbolt168_75axial\tbolt168_75shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt191_25.txt','w')
f.write('bolt191_25f\tbolt191_25axial\tbolt191_25shear\truptured\tnodePosFrCentre\n')
f.close()

f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt15.txt','w')
f.write('bolt15f\tbolt15axial\tbolt15shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt30.txt','w')
f.write('bolt30f\tbolt305axial\tbolt30shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt60.txt','w')
f.write('bolt60f\tbolt60axial\tbolt60shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt75.txt','w')
f.write('bolt75f\tbolt75axial\tbolt75shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt105.txt','w')
f.write('bolt105f\tbolt105axial\tbolt105shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt120.txt','w')
f.write('bolt120f\tbolt120axial\tbolt120shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt150.txt','w')
f.write('bolt150f\tbolt150axial\tbolt150shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt165.txt','w')
f.write('bolt165f\tbolt165axial\tbolt165shear\truptured\tnodePosFrCentre\n')
f.close()

f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltL1.txt','w')
f.write('boltL1f\tboltL1axial\tboltL1shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltL2.txt','w')
f.write('boltL2f\tboltL2axial\tboltL2shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltR1.txt','w')
f.write('boltR1f\tboltR1axial\tboltR1shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltR2.txt','w')
f.write('boltR2f\tboltR2axial\tboltR2shear\truptured\tnodePosFrCentre\n')
f.close()

f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt5.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt10.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt20.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt25.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt35.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt40.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt50.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt55.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt65.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt70.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt80.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt85.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt95.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt100.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt110.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt115.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt125.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt130.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt140.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt145.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt155.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt160.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt170.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt175.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltm5.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltm10.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltm15.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltmEast5.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltmEast10.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltmEast15.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()


f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/lining.txt','w')
...
def recordLining(stageNo):
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/lining.txt','a')	
	count = 0
...
def record(stageNo):
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltMinus225.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt0.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt225.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt45.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt675.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt90.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt113.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt135.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt158.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt180.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt2025.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltMinus11_25.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt11_25.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt33_75.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt56_25.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt78_75.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt101_25.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt123_75.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt146_25.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt168_75.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt191_25.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltL1.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltL2.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltR1.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltR2.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt15.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt30.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt60.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt75.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt105.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt120.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt150.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt165.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt5.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt10.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt20.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt25.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt35.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt40.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt50.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt55.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt65.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt70.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt80.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt85.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt95.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt100.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt110.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt115.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt125.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt130.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt140.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt145.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt155.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt160.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt170.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/bolt175.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltm5.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltm10.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltm15.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltmEast5.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltmEast10.txt','a')	
	count = 0
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('/home/boon/yadeRev/trunk/examples/Tunnel/vtk/boltmEast15.txt','a')	
	count = 0
