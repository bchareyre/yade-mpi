...
'''
readParamsFromTable(noTableOk=True,N=100,M=10,merge=1)
...
def collectTimingMPI():
        created = os.path.isfile("EngineTimings_2D_weakScalability-POSTHACK1-"+timeStr+".dat")
        f=open("EngineTimings_2D_weakScalability-POSTHACK1-"+timeStr+".dat",'a')
...
if rank==0:
        wallTime = end - start
        created = os.path.isfile("wallTimes_2D_weakScalability-POSTHACK1-"+timeStr+".dat")
        f=open('wallTimes_2D_weakScalability-POSTHACK1-'+timeStr+'.dat','a')
