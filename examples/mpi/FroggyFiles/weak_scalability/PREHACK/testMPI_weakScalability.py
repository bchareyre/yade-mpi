...
def collectTimingMPI():
        created = os.path.isfile("EngineTimings_2D_weakScalability-PREHACK-"+timeStr+".dat")
        f=open("EngineTimings_2D_weakScalability-PREHACK-"+timeStr+".dat",'a')
...
if rank==0:
        wallTime = end - start
        created = os.path.isfile("wallTimes_2D_weakScalability-PREHACK-"+timeStr+".dat")
