...
def collectTimingMPI():
	created = os.path.isfile("EngineTimings_2D_strongScalability-PREHACK-"+timeStr+".dat")
	f=open("EngineTimings_2D_strongScalability-PREHACK-"+timeStr+".dat",'a')
...
if rank==0:
	#end = time.time()
	wallTime = end - start
	created = os.path.isfile("wallTimes_2D_strongScalability-PREHACK-"+timeStr+".dat")
	f=open('wallTimes_2D_strongScalability-PREHACK-'+timeStr+'.dat','a')
