...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public : void action(const vector<SphericalDEM>& spheres, ContactVecSet& contacts);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	protected : void updateIds(unsigned int nbElements, ContactVecSet& contacts);
	...
	protected : void sortBounds(vector<shared_ptr<AABBBound> >& bounds, int nbElements, ContactVecSet& contacts);
	...
	protected : void updateOverlapingBBSet(int id1,int id2, ContactVecSet& contacts);
	...
	protected : void findOverlappingBB(vector<shared_ptr<AABBBound> >& bounds, int nbElements, ContactVecSet& contacts);
};
