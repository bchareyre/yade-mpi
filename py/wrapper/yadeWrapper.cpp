...
BOOST_PYTHON_MODULE(wrapper)
{
	...
	python::class_<pyOmega>("Omega")
		...
		.def("getSceneAsString",&pyOmega::getSceneAsString,"Return the entire scene as a string. Equivalent to using O.save(...) except that the scene goes to a string instead of a file.")
