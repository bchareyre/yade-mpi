...
All line plots take an optional second string argument, which is composed of (optionally) a line color (eg, ’r’, ’g’, ’k’), a line style (eg, ’-’, ’–’, ’:’) and a line marker (’o’, ’s’, ’d’). For example a green dashed line with circle markers is created with ’go–’ argument.
