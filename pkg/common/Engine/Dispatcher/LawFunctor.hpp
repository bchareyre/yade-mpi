...
class LawFunctor: public Functor2D <
	...
	void addForce (const body_id_t id, const Vector3r& f,Scene* rb){rb->bex.addForce (id,f);}
	void addTorque(const body_id_t id, const Vector3r& t,Scene* rb){rb->bex.addTorque(id,t);}
