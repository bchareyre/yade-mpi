...
YADE_PLUGIN((L3Geom)(L6Geom)(Ig2_Sphere_Sphere_L3Geom)(Ig2_Wall_Sphere_L3Geom)(Ig2_Sphere_Sphere_L6Geom)(Law2_L3Geom_FrictPhys_ElPerfPl)(Law2_L6Geom_FrictPhys_Linear)
	#ifdef YADE_OPENGL
...
bool Ig2_Wall_Sphere_L3Geom::go(const shared_ptr<Shape>& s1, const shared_ptr<Shape>& s2, const State& state1, const State& state2, const Vector3r& shift2, const bool& force, const shared_ptr<Interaction>& I){
	...
	L3Geom& g=I->geom->cast<L3Geom>();
	if(g.normal!=normal) throw std::logic_error(("Ig2_Wall_Sphere_L3Geom: normal changed in Wall+Sphere ##"+lexical_cast<string>(I->getId1())+"+"+lexical_cast<string>(I->getId2())+" (with Wall.sense=0, a particle might cross the Wall plane, if Δt is too high)").c_str());
	...
	// perhaps not necessary, see in Ig2_Sphere_Sphere_L3Geom
