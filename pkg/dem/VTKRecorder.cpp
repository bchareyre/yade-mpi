...
void VTKRecorder::action(){
	...
	FOREACH(string& rec, recorders){
		...
		else LOG_ERROR("Unknown recorder named `"<<rec<<"' (supported are: all, spheres, velocity, facets, boxes, color, stress, cpm, wpm, intr, id, clumpId, materialId, jcfpm, cracks). Ignored.");
	}
